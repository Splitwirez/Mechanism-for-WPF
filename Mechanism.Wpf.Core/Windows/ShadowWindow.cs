    ...
    public class ShadowWindow : CompositingWindow
    {
        ...
        public void SyncShadowToWindow()
        {
            if (IsVisible)
            {
                ...
                if (cx > System.Windows.Forms.SystemInformation.VirtualScreen.Width)
                    cx = System.Windows.Forms.SystemInformation.VirtualScreen.Width;
                ...
                if (cy > System.Windows.Forms.SystemInformation.VirtualScreen.Height)
                    cy = System.Windows.Forms.SystemInformation.VirtualScreen.Height;
